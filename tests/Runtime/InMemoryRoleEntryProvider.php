...
use Vaened\Sentinel\Authorization\RoleEntries;
use Vaened\Sentinel\Authorization\RoleEntry;
use Vaened\Sentinel\Authorization\RoleEntryProvider;
use Vaened\Sentinel\Role;
use Vaened\Sentinel\Repositories\SubjectRoleRepository;
use Vaened\Sentinel\Subject;

final readonly class InMemoryRoleEntryProvider implements RoleEntryProvider
{
